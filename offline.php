...
$doc->addStyleSheet($tpath.'/offline/scripts/jquery.vegas.css'); 
...
<head>
	...
	<script src="<?php echo $tpath; ?>/offline/scripts/jquery.vegas.min.js"></script>
...
<body>
	...
	jQuery(document).ready(function() {
		...
		jQuery.vegas('slideshow', {
		  delay:10000,
		  backgrounds:[
			{ src:'<?php echo $tpath;?>/offline/scripts/images/bg/1.jpg', fade:1000 },
			{ src:'<?php echo $tpath;?>/offline/scripts/images/bg/2.jpg', fade:1000 }
		  ]
		})('overlay', {
		  src:'<?php echo $tpath;?>/offline/scripts/overlays/06.png'
		});
